  ...
  return (
    <div className="border border-border bg-surface p-5 flex flex-col sm:flex-row sm:items-center gap-4 justify-between print:hidden">
      ...
      <Link
        ...
        className="shrink-0 self-start sm:self-center text-sm px-5 py-3 border border-stone-900 dark:border-stone-50 bg-white dark:bg-stone-900 text-foreground hover:bg-stone-900 hover:text-white dark:hover:bg-stone-50 dark:hover:text-foreground transition-colors whitespace-nowrap"
      >
        提携先の紹介を見る
      </Link>
    </div>
