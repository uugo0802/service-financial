...
function RecommendationCard({ item }: { item: CrossSellRecommendation }) {
  return (
    <div className="border border-stone-300 bg-white rounded-lg p-5 flex flex-col gap-3">
...
export function CrossSellRecommendations({ items }: { items: CrossSellRecommendation[] }) {
  return (
    <section className="flex flex-col gap-4">
      ...
      {items.length === 0 ? (
        <div className="border border-dashed border-stone-300 rounded-lg p-6 text-sm text-stone-500">
      ...
      <p className="text-xs text-stone-500 border-t border-stone-200 pt-4 mt-2 leading-relaxed">
