    ...
    <section className="flex flex-col gap-6">
      <div className="border-2 border-foreground">
        <div className="flex items-baseline justify-between gap-3 border-b-2 border-foreground px-3 py-2">
          ...
          <div className="text-xs text-stone-500 shrink-0">{form.fiscalYearLabel}</div>
        </div>

        <div className="px-3 py-2 text-xs text-stone-500 space-y-0.5">
          <div>
            提出者: <span className="font-medium text-stone-800">{form.submitter.name}</span>
          </div>
        ...
        <div className="grid sm:grid-cols-3 gap-3 px-3 py-3 border-t border-stone-200">
          <div className="border border-stone-200 rounded p-3">
            <p className="text-xs text-stone-500">提出枚数（人員）合計</p>
      ...
      {form.sections.map((section) => (
        <div key={section.id} className="border border-stone-300">
          <div className="flex items-baseline justify-between gap-3 border-b border-stone-300 bg-stone-50 px-3 py-2">
          ...
          {section.notes.length > 0 && (
            <ul className="px-3 py-2 border-t border-stone-200 text-xs text-stone-500 leading-relaxed list-disc list-inside space-y-1">
