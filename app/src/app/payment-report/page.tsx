    ...
    <div className="bg-stone-50 text-stone-900 min-h-screen">
      <header className="border-b border-stone-300 bg-white">
        <div className="mx-auto max-w-5xl px-6 py-4 flex items-baseline justify-between">
          ...
          <div className="text-xs text-stone-500">支払調書（下書き）</div>
        </div>
      </header>
      ...
      <PageContainer as="main" maxWidth="5xl" className="flex flex-col gap-8">
        <section>
          ...
          <p className="text-sm text-stone-600 mb-2 max-w-2xl leading-relaxed">
            ...
            <Link href="/general-ledger" className="underline hover:text-stone-900">総勘定元帳</Link>
          ...
          <div className="mt-6 border border-stone-300 bg-white p-5 flex flex-col gap-4">
            <label className="flex flex-col gap-1 text-xs text-stone-500 max-w-[12rem]">
              対象年
              <select
                value={fiscalYear}
