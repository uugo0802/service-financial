      ...
      <main className="mx-auto max-w-5xl px-4 sm:px-6 py-10 flex flex-col gap-10">
        <section>
          ...
          <div className="flex flex-col gap-4">
            <div>
              <div className="text-xs text-muted-foreground mb-2" id="entity-mode-label">事業形態</div>
            ...
            <div>
              <label htmlFor="entityName" className="block text-xs text-muted-foreground mb-2">
              ...
              <input
                ...
                className="w-full max-w-md border border-border bg-surface px-4 py-3 text-sm outline-none focus:border-foreground/40"
              />
            </div>

            {mode === "corp" && (
              <div>
                <div className="text-xs text-muted-foreground mb-2">貸借対照表用の入力（期首時点の想定値）</div>
            ...
            <div>
              <div className="text-xs text-muted-foreground mb-2">明細データ</div>
              <label
          ...
          {loading && <p className="mt-3 text-sm text-muted-foreground">解析中…</p>}
          ...
          {pendingDuplicateUpload && (
            <div className="mt-4 border border-red-300 bg-red-50 p-4 text-sm">
              ...
              <ul className="mt-3 max-h-40 overflow-y-auto text-xs text-muted-foreground space-y-1 border-t border-red-200 pt-2">
              ...
              <div className="mt-3 flex flex-wrap gap-3">
                <button
                  ...
                  className="text-sm px-4 py-2 border border-accent bg-accent text-white hover:opacity-90 transition-colors"
                >
                  重複を除外して反映する（推奨）
                </button>
                <button
                  ...
                  className="text-sm px-4 py-2 border border-border bg-surface hover:border-foreground/40 transition-colors"
                >
                  そのまま全件反映する
                </button>
              </div>
              ...
              <table className="w-full min-w-[42rem] text-sm">
                ...
                <tbody>
                  {rows.map((r) => {
                    ...
                    return (
                      <tr key={r.id} className={`border-b border-border/60 last:border-0 ${needsReview ? "bg-red-50" : ""}`}>
                        ...
                        <td className={`px-3 py-2 text-right whitespace-nowrap tabular-nums ${r.amount < 0 ? "text-foreground" : "text-emerald-700"}`}>
                          {yen.format(r.amount)}
                        </td>
                        <td className="px-3 py-2">
                          <input
                            className="w-full min-w-[7rem] bg-transparent border-b border-transparent focus:border-border outline-none"
                            value={r.account}
        ...
        {mode === "individual" && individualEstimate && (
          <section>
            ...
            <div className="mb-4 print:hidden">
              ...
              {showItemizedDeductions && (
                <div className="mt-3 border border-border bg-surface p-4 sm:p-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <fieldset className="flex flex-col gap-2">
                      <legend className="text-xs font-semibold text-muted-foreground mb-1">地震保険料控除</legend>
                      <label className="flex flex-col gap-1 text-xs text-muted-foreground">
                        年間支払保険料
                        <input
                          type="number"
                    ...
                    <fieldset className="flex flex-col gap-2">
                      <legend className="text-xs font-semibold text-muted-foreground mb-1">寄附金控除（ふるさと納税を含む）</legend>
                      <label className="flex flex-col gap-1 text-xs text-muted-foreground">
                        年間寄附金合計額
                        <input
                          type="number"
                    ...
                    <fieldset className="flex flex-col gap-2">
                      <legend className="text-xs font-semibold text-muted-foreground mb-1">医療費控除</legend>
                      <label className="flex flex-col gap-1 text-xs text-muted-foreground">
                        年間医療費合計額（保険金等による補填前）
                        <input
                          type="number"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="border border-border bg-surface p-5">
                <div className="text-xs text-muted-foreground mb-3">所得税（概算）</div>
              ...
              <div className="border border-border bg-surface p-5">
                <div className="text-xs text-muted-foreground mb-3">消費税（概算）</div>
                <dl className="text-sm space-y-2">
        ...
        {mode === "corp" && corpEstimate && (
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="border border-border bg-surface p-5">
                <div className="text-xs text-muted-foreground mb-3">法人税・地方法人税（概算）</div>
                <dl className="text-sm space-y-2">
