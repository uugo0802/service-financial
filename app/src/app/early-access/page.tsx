    ...
    <div className="bg-background text-foreground min-h-screen">
      ...
      <main className="mx-auto max-w-4xl px-6 py-16 flex flex-col gap-20">
        ...
        <section className="grid sm:grid-cols-2 gap-8">
          <div className="border border-border bg-surface rounded-lg p-6 flex flex-col gap-4">
        ...
        <section className="flex flex-col gap-6">
          ...
          <div className="grid sm:grid-cols-3 gap-6 text-sm text-muted-foreground">
            <div className="flex flex-col gap-2">
              <div className="font-medium text-foreground">仕訳確認ゼロを目指す</div>
              <p>AIによる自動仕訳の確定率を最大化。人間のレビューは例外処理のみに絞ります。</p>
            </div>
            <div className="flex flex-col gap-2">
              <div className="font-medium text-foreground">送信完了まで伴走</div>
              <p>申告書下書きの作成で終わらず、e-Tax/eLtax送信までチェックリスト形式でナビゲートします。</p>
            </div>
            <div className="flex flex-col gap-2">
              <div className="font-medium text-foreground">低価格・低運用コスト</div>
