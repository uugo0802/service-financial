...
export const metadata: Metadata = {
  title:
    "決算書類（貸借対照表・株主資本等変動計算書・キャッシュ・フロー計算書・個別注記表・勘定科目内訳明細書・法人事業概況説明書）｜決算書作成から税務申告までワンクリック（スグル）",
  description:
    "記帳データから貸借対照表・株主資本等変動計算書・キャッシュ・フロー計算書・個別注記表・勘定科目内訳明細書・法人事業概況説明書の概算下書きをまとめて確認できる画面（開発中プロトタイプ）。",
};
    ...
    <div className="bg-background text-foreground min-h-screen">
      ...
      <DocumentPreviewFrame as="main" maxWidth="4xl" className="flex flex-col gap-10">
        <section className="flex flex-col gap-4">
          <h1 className="text-2xl font-semibold">
            決算書類（貸借対照表・株主資本等変動計算書・キャッシュ・フロー計算書・個別注記表・勘定科目内訳明細書・法人事業概況説明書）
          </h1>
          <p className="text-sm text-stone-600 leading-relaxed max-w-2xl">
            記帳された取引明細と資本金・期首現金残高の入力から、貸借対照表・株主資本等変動計算書・キャッシュ・フロー計算書・個別注記表に加え、
      ...
      <footer className="border-t border-border bg-surface mt-4">
        <div className="mx-auto max-w-4xl px-6 py-8 text-xs text-muted-foreground leading-relaxed">
          ...
          表示される貸借対照表・株主資本等変動計算書・キャッシュ・フロー計算書・個別注記表・勘定科目内訳明細書・法人事業概況説明書は記帳内容に基づく簡易試算であり、
